...
namespace infnet_bl6_fdaN_at.Controllers
{
    public class PessoasController : Controller
    {
        private readonly infnet_bl6_fdaN_atContext _context;

        public PessoasController(infnet_bl6_fdaN_atContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> ConfirmarExcluir(int id)
        {
            ...
            {
                return Problem("Entity set 'infnet_bl6_fdaN_atContext.Pessoa'  is null.");
            }
            var pessoa = await _context.Pessoa.FindAsync(id);
            if (pessoa != null)
            {
